                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                        <div class="body">
                            ...
                            <a href="../consultant/clinic.php?id=<?php echo $clinic->id ?>" style="font-size: large">&laquo; Back</a>
                            <ul style="font-size: large;">

                                <li><a href="../medicalReports/travelling.php?id=<?php echo $clinic->id ?>">Medical Certificate Of Fitness For Travelling </a></li>
