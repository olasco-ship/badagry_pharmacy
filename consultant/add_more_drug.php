...
if (empty($drugRequest)){
    redirect_to("review_drug.php?id=$drugRequest->waiting_list_id");
}
...
if (is_post()){
    if (isset($_POST['save_drug'])) {
        ...
        redirect_to("addMore_drugboard.php?id=$drugRequest->id");
...
?>
    ...
    <div id="main-content">
        <div class="container-fluid">
            ...
            <a href="review_drug.php?id=<?php echo $drugRequest->waiting_list_id ?>"> << Back </a>
