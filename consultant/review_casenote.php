...
if (is_post()) {
    ...
    $anaesthesia->date                  = $d_time;
    $anaesthesia->time                  = $d_time1;
    ...
    if ($waiting_list->sub_clinic_id == $depts->id){
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12">
                                ...
                                <form action="" method="post">
                                    ...
                                    $userDept = Clinic::find_by_name($dept);
                                    foreach ($userDept as $depts){
                                        $userSubClin = UserSubClinic::find_by_user_clinic_id($user->id, $depts->id);
                                    }
...
//                                    }
                                    ...
                                    if (!empty($userSubClinic)){
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <strong>Date:</strong>
                                                <input type="date" name="d_time" value="<?php echo $decoded->date ?>" id="d_time" class="form-control">
                                            </div>
                                            <div class="col-sm-4">
                                                <strong>Time:</strong>
                                                <input type="time" name="d_time1" value="<?php echo $decoded->time ?>" id="d_time1" class="form-control">
                                            </div>
                                        </div>
