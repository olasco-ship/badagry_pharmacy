                                    ...
                                    if (is_post()) {
                                       ...
                                       foreach ($patients as $patient) {
                                        ...
                                        <?php   
                                         ...
                                         $sql  = "SELECT * FROM patients p left join medical_reports m on m.patient_id = p.id AND m.status='' WHERE p.id = m.patient_id ";
                                         //var_dump($sql);exit;
                                         $sql .= "LIMIT {$per_page} ";
                                         $sql .= "OFFSET {$pagination->offset()}";
                                         $patients = Patient::find_by_sql($sql);
...
/*
                                           ...
                                           // if(isset($med)){
                                          $pat = Bill::find_by_patient_medicalRep($patient->patient_id);/* var_dump($pat);exit;*/
                                            ?>
                                            <tr>
                                                <td><?php echo $index++ ?></td>
                                                <td><a href='view.php?id=<?php echo $patient->id ?>'><?php echo $patient->folder_number ?></a></td>
                                                ...
                                                <td><a href="bill_patient.php?id= <?php echo $patient->id ?>"><?php if(empty($pat)){ echo "Bill"; ?></a>
                                                <?php }else{ ?>
                                                   <a href = "#"> <?php echo "Billed";
                                                }?></a></td>


                                                 <td><?php if($pat){ ?><a href="demo.php?id=<?php echo $patient->id?>"><? echo "Print"; ?></a>
                                                 <?php }else{  ?>
